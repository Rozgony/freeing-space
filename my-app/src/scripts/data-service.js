import brazilIndigenousOfficial from './../geoJSONs/brazil_indigenous_official.js';
...
function getStaticData(){
	...
	const projectsData = [];
	const housingData = [];
	brazilIndigenousOfficial.forEach((space,i) => {
		polygonData.push(convertBrazilIndigenousToGeoJSON(space));
		landData.push(convertBrazilIndigenousToGeoJSONPoint(space));
	});      
